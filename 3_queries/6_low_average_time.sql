...
-- This will require data from students, assignment_submissions, and assignment
SELECT students.name as student_name, AVG(assignment_submissions.duration) as average_time, AVG(assignments.duration) as estimated_time
FROM assignments
